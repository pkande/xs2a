...
public class UpdatePisAuthorizationLinksTest {
    ...
    private UpdatePisAuthorizationLinks links;
    ...
    public void isScaStatusMethodAuthenticated() {
        ...
        links = new UpdatePisAuthorizationLinks(HTTP_URL, scaApproachResolver, response, request);
