...
public class CreatePisAuthorizationLinksTest {
    ...
    private CreatePisAuthorizationLinks links;
    ...
    public void isScaStatusMethodAuthenticatedAndEmbeddedScaApproachAndPsuDataIsEmpty() {
        ...
        links = new CreatePisAuthorizationLinks(HTTP_URL, scaApproachResolver, redirectLinkBuilder, request, AUTHORISATION_ID);
    ...
    public void scaApproachRedirect() {
        ...
        when(redirectLinkBuilder.buildPaymentScaRedirectLink(eq(PAYMENT_ID), eq(AUTHORISATION_ID))).thenReturn(BUILT_LINK);
