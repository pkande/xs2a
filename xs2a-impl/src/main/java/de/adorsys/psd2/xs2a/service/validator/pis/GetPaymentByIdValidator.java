...
public class GetPaymentByIdValidator extends AbstractTppValidator<GetPaymentByIdPO> {
    private final GetCommonPaymentByIdResponseValidator getCommonPaymentByIdResponseValidator;

    @Override
    ValidationResult executeBusinessValidation(GetPaymentByIdPO object) {
        ValidationResult getCommonPaymentValidationResult =
            getCommonPaymentByIdResponseValidator.validateRequest(object.getPisCommonPaymentResponse(),
