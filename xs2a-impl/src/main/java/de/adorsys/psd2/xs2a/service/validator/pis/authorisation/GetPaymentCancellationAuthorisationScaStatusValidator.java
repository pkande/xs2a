 ...
 */
@Component
public class GetPaymentCancellationAuthorisationScaStatusValidator extends AbstractPisTppValidator<CommonPO> {
     ...
     */
    @Override
    protected ValidationResult executeBusinessValidation(CommonPO paymentObject) {
