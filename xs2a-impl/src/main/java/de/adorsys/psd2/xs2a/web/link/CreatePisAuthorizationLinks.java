...
public class CreatePisAuthorizationLinks extends AbstractLinks {

    public CreatePisAuthorizationLinks(String httpUrl, ScaApproachResolver scaApproachResolver, RedirectLinkBuilder redirectLinkBuilder,
