...
| [xs2a]#CMS#
| Consent Management System A Service that persists and manages the PSUs Consents for account accesses and payments and corresponding to these consents data.
